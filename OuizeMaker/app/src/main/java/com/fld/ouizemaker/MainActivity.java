...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView name_txt, unit_txt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        unit_txt = findViewById(R.id.unit_tex_view);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (users.isEmpty() || units.isEmpty()) {
                    Toast.makeText(getApplicationContext(), "NO STUDENTS OR UNITS!!", Toast.LENGTH_SHORT).show();
                } else {
                    int units_number = random.nextInt(count) + 1;
                    String unitsNum = String.valueOf(units_number);
                    for (int i = 0; i < units.size(); i++) {
                        unit_txt.setText(unitsNum);
